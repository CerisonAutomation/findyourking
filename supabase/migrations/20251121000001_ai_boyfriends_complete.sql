...
CREATE TABLE IF NOT EXISTS public.ai_boyfriend_templates (
  ...
  verbosity integer CHECK (verbosity >= 0 AND verbosity <= 100),
  humor integer CHECK (humor >= 0 AND humor <= 100),
  emotiveness integer CHECK (emotiveness >= 0 AND emotiveness <= 100),
  playfulness integer CHECK (playfulness >= 0 AND playfulness <= 100),
  flirtiness integer CHECK (flirtiness >= 0 AND flirtiness <= 100),
  romantic_intensity integer CHECK (romantic_intensity >= 0 AND romantic_intensity <= 100),
